...
class RevParItem extends StatefulWidget {
  final DateTime? fromDate;
  final DateTime? toDate;

  RevParItem({this.fromDate, this.toDate});

  @override
  State<RevParItem> createState() => _RevParItemState();
}

class _RevParItemState extends State<RevParItem> {
  ...
  @override
  void didUpdateWidget(covariant RevParItem oldWidget) {
